...
- (void)setUpUI {
    ...
    self.tgWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, IPHONE_NAVIGATIONBAR_HEIGHT, kMainScreenBoundwidth, kMainScreenBoundheight-IPHONE_NAVIGATIONBAR_HEIGHT)];
