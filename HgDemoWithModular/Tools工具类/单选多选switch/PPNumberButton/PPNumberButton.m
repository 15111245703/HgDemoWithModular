...
//    [button addTarget:self action:@selector(touchUp2) forControlEvents:UIControlEventTouchUpInside];
//    [button addTarget:self action:@selector(touchUp3) forControlEvents:UIControlEventTouchCancel];
