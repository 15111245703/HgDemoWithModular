...
@interface SYYNavgationViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong)UITableView *tableView ;
@property (nonatomic,strong)NSArray *dataArray ;
@property (nonatomic,strong)NSArray *navDataArray ;
@end

@implementation SYYNavgationViewController
...
- (void)viewDidLoad {
    ...
    [self.navigationView addRightButtonWithTitle:@"你牛" clickCallBack:^(UIView *view) {
