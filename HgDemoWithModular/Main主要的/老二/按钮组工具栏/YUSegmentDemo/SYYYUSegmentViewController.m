...
#import "SecondCell.h"
#import "YUSegment.h"
@interface SYYYUSegmentViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@end
@implementation SYYYUSegmentViewController
...
- (void)viewDidLoad {
    ...
    [_segmentedControl addTarget:self action:@selector(segmentedControlTapped:) forControlEvents:UIControlEventValueChanged];
     ...
     _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, STATUSBAR_HEIGHT+kNavNormalHeight, kMainScreenBoundwidth, kMainScreenBoundheight) style:UITableViewStylePlain];
